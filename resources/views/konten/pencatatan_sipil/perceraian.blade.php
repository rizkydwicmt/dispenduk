...
@section('title', 'Daftar Pencatatan Sipil - Admin Panel')
@section('page-title', 'Daftar Pencatatan Sipil')
...
@section('konten')
    ...
    <div class="card">
        <div class="card-header">
            <div class="col-12">
                <div class="card-header">
                    <h4 class="card-title">Statistik Pencatatan Sipil - Perceraian</h4>
                </div>
